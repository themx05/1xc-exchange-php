...
class PaymentGateway {
    ...
    public static function getCurrencyFromMethod(Method $method){
        if($method->category === Method::CATEGORY_CRYPTO){
            return $method->type;
        }
    ...
    public static function addressFromMethod(Method $method){
        ...
        if($method->category === Method::CATEGORY_MOBILE){
            return $method->details->address;
        }
        else if($method->category === Method::CATEGORY_BANKING || $method->category === Method::CATEGORY_TRANSFER){
